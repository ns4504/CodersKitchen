...
require_once('../controller/cuisine.php');
require_once('../controller/cuisine_controller.php');
...
<body>
  ...
  <?php foreach (CuisineController::getAllCuisines() as $cuisine) : ?>
  <h1 id="sorting-header" style="color: black;"><center><?php echo $cuisine->getCuisineName(); ?></center></h1>
    <?php foreach (RecipeController::getRecipesByCuisine($cuisine->getCuisineId()) as $recipe) : ?>
